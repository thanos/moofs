...
## Issue tracker
moofs uses the excellent [GitHub issue tracker][issues].

Personally, I also recommend giving [ZenHub][zenhub] a try. After installing the Google Chrome plugin, visit the [moofs boards][repo-boards]. This way, it's very easy to get an overview of the current bug/feature request situation.
...
### Report Bugs
Report bugs at [thanos/moofs/issues][issues].
...
### Write Documentation
moofs could always use more documentation, whether as part of the official moofs docs, in inline docstrings, or even on the web in blog posts, articles, and such.
...
## Get Started!
Ready to contribute? Here's how to set up `moofs` for local development.

> Over time my ambition is to provide a reproducable and automated setup through Vagrant.

1. Fork the [thanos/moofs][repo] repo on GitHub

2. Clone your fork locally:

  ```bash
  $ git clone git@github.com:<your github username>/moofs.git
  ```
...
## Coding conventions
Generally I recommend two ways to stay up-to-date on moofs coding standards.
...
[issues]: https://github.com/thanos/moofs/issues
[repo]: https://github.com/thanos/moofs
[repo-boards]: https://github.com/thanos/moofs/issues#boards
[sourcetree]: http://www.sourcetreeapp.com/
[travis]: https://travis-ci.org/thanos/moofs/pull_requests
